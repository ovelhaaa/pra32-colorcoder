...
//
// This is the same table that the embedded engine carries in
// `pra32-u2-program-table.h` (and that `pra32-u2-prog-factory-presets.json`
// mirrors), expressed as the JSON the preset loader understands. Keeping it in
// one header avoids the large duplicated literal that used to live inline inside
// PluginProcessor.cpp.
//
